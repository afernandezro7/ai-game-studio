...
1. **Cambio en los Costes Iniciales:**
   ...
   - *Justificación:* La Madera es el recurso de construcción base. El jugador siempre debe poder construir recolectores usando el recurso más básico.

2. **Producción Base del Gran Salón:**
   - El Gran Salón Nivel 1 debería tener una producción pasiva mínima (ej. 50 Madera/hora y 50 Acero/hora) para garantizar que un jugador *nunca* se quede con producción 0.
